...
void C_MTX44MultVec(const Mtx44 m, const Vec* src, Vec* dst) {
    ...
    OSAssertMessage_Line(76, m, "MTX44MultVec():  NULL Mtx44Ptr 'm' ");
    OSAssertMessage_Line(77, src, "MTX44MultVec():  NULL VecPtr 'src' ");
    OSAssertMessage_Line(78, dst, "MTX44MultVec():  NULL VecPtr 'dst' ");
...
void C_MTX44MultVecArray(const Mtx44 m, const Vec* srcBase, Vec* dstBase, u32 count) {
    ...
    OSAssertMessage_Line(163, m, "MTX44MultVecArray():  NULL Mtx44Ptr 'm' ");
    OSAssertMessage_Line(164, srcBase, "MTX44MultVecArray():  NULL VecPtr 'srcBase' ");
    OSAssertMessage_Line(165, dstBase, "MTX44MultVecArray():  NULL VecPtr 'dstBase' ");
...
void C_MTX44MultVecSR(const Mtx44 m, const Vec* src, Vec* dst) {
    ...
    OSAssertMessage_Line(299, m, "MTX44MultVecSR():  NULL Mtx44Ptr 'm' ");
    OSAssertMessage_Line(300, src, "MTX44MultVecSR():  NULL VecPtr 'src' ");
    OSAssertMessage_Line(301, dst, "MTX44MultVecSR():  NULL VecPtr 'dst' ");
...
void C_MTX44MultVecArraySR(const Mtx44 m, const Vec* srcBase, Vec* dstBase, u32 count) {
    ...
    OSAssertMessage_Line(390, m, "MTX44MultVecArraySR():  NULL Mtx44Ptr 'm' ");
    OSAssertMessage_Line(391, srcBase, "MTX44MultVecArraySR():  NULL VecPtr 'srcBase' ");
    OSAssertMessage_Line(392, dstBase, "MTX44MultVecArraySR():  NULL VecPtr 'dstBase' ");

...
void C_MTXIdentity(Mtx m) {
    OSAssertMessage_Line(203, m, "MtxIdentity():  NULL Mtx 'm' ");
    m[0][0] = 1;
    m[0][1] = 0;
    m[0][2] = 0;
    m[0][3] = 0;
...
void C_MTXCopy(const Mtx src, Mtx dst) {
    OSAssertMessage_Line(264, src, "MTXCopy():  NULL MtxPtr 'src' ");
    OSAssertMessage_Line(265, dst, "MTXCopy():  NULL MtxPtr 'dst' ");
    if (src != dst) {
        dst[0][0] = src[0][0];
        dst[0][1] = src[0][1];
        dst[0][2] = src[0][2];
...
void C_MTXConcat(const Mtx a, const Mtx b, Mtx ab) {
    ...
    OSAssertMessage_Line(338, a, "MTXConcat():  NULL MtxPtr 'a'  ");
    OSAssertMessage_Line(339, b, "MTXConcat():  NULL MtxPtr 'b'  ");
    OSAssertMessage_Line(340, ab, "MTXConcat():  NULL MtxPtr 'ab' ");
...
void C_MTXConcatArray(const Mtx a, const Mtx* srcBase, Mtx* dstBase, u32 count) {
    ...
    OSAssertMessage_Line(594, a != 0, "MTXConcatArray(): NULL MtxPtr 'a' ");
    OSAssertMessage_Line(595, srcBase != 0, "MTXConcatArray(): NULL MtxPtr 'srcBase' ");
    OSAssertMessage_Line(596, dstBase != 0, "MTXConcatArray(): NULL MtxPtr 'dstBase' ");
    OSAssertMessage_Line(597, count > 1, "MTXConcatArray(): count must be greater than 1.");
...
void C_MTXTranspose(const Mtx src, Mtx xPose) {
    ...
    OSAssertMessage_Line(865, src, "MTXTranspose():  NULL MtxPtr 'src' ");
    OSAssertMessage_Line(866, xPose, "MTXTranspose():  NULL MtxPtr 'xPose' ");
...
u32 C_MTXInverse(const Mtx src, Mtx inv) {
    ...
    OSAssertMessage_Line(964, src, "MTXInverse():  NULL MtxPtr 'src' ");
    OSAssertMessage_Line(965, inv, "MTXInverse():  NULL MtxPtr 'inv' ");
...
u32 C_MTXInvXpose(const Mtx src, Mtx invX) {
    ...
    OSAssertMessage_Line(1198, src, "MTXInvXpose(): NULL MtxPtr 'src' ");
    OSAssertMessage_Line(1199, invX, "MTXInvXpose(): NULL MtxPtr 'invX' ");
...
void C_MTXRotTrig(Mtx m, char axis, f32 sinA, f32 cosA) {
    OSAssertMessage_Line(1501, m, "MTXRotTrig():  NULL MtxPtr 'm' ");
    switch(axis) {
        case 'x':
        case 'X':
            m[0][0] = 1;
        ...
        case 'Z':
            ...
            break;
        default:
            OSAssertMessage_Line(1528, FALSE, "MTXRotTrig():  invalid 'axis' value ");
            break;
    }
}
...
void C_MTXTrans(Mtx m, f32 xT, f32 yT, f32 zT) {
    OSAssertMessage_Line(1865, m, "MTXTrans():  NULL MtxPtr 'm' ");
    m[0][0] = 1;
    m[0][1] = 0;
    m[0][2] = 0;
    m[0][3] = xT;
...
void C_MTXTransApply(const Mtx src, Mtx dst, f32 xT, f32 yT, f32 zT) {
    OSAssertMessage_Line(1932, src, "MTXTransApply(): NULL MtxPtr 'src' ");
    OSAssertMessage_Line(1933, dst, "MTXTransApply(): NULL MtxPtr 'src' "); //! wrong assert string
...
void C_MTXScale(Mtx m, f32 xS, f32 yS, f32 zS) {
    OSAssertMessage_Line(2007, m, "MTXScale():  NULL MtxPtr 'm' ");
    m[0][0] = xS;
    m[0][1] = 0;
    m[0][2] = 0;
    m[0][3] = 0;
...
void C_MTXScaleApply(const Mtx src, Mtx dst, f32 xS, f32 yS, f32 zS) {
    OSAssertMessage_Line(2069, src, "MTXScaleApply(): NULL MtxPtr 'src' ");
    OSAssertMessage_Line(2070, dst, "MTXScaleApply(): NULL MtxPtr 'dst' ");
    dst[0][0] = (src[0][0] * xS);
    dst[0][1] = (src[0][1] * xS);
    dst[0][2] = (src[0][2] * xS);
    dst[0][3] = (src[0][3] * xS);
...
void C_MTXQuat(Mtx m, const Quaternion* q) {
    ...
    OSAssertMessage_Line(2144, m, "MTXQuat():  NULL MtxPtr 'm' ");
    OSAssertMessage_Line(2145, q, "MTXQuat():  NULL QuaternionPtr 'q' ");
    OSAssertMessage_Line(2146, q->x || q->y || q->z || q->w, "MTXQuat():  zero-value quaternion ");
...
void C_MTXLookAt(Mtx m, const Vec* camPos, const Vec* camUp, const Vec* target) {
    ...
    OSAssertMessage_Line(2437, m, "MTXLookAt():  NULL MtxPtr 'm' ");
    OSAssertMessage_Line(2438, camPos, "MTXLookAt():  NULL VecPtr 'camPos' ");
    OSAssertMessage_Line(2439, camUp, "MTXLookAt():  NULL VecPtr 'camUp' ");
    OSAssertMessage_Line(2440, target, "MTXLookAt():  NULL Point3dPtr 'target' ");
...
void C_MTXLightFrustum(Mtx m, f32 t, f32 b, f32 l, f32 r, f32 n, f32 scaleS, f32 scaleT, f32 transS, f32 transT) {
    ...
    OSAssertMessage_Line(2540, m, "MTXLightFrustum():  NULL MtxPtr 'm' ");
    OSAssertMessage_Line(2541, (t != b), "MTXLightFrustum():  't' and 'b' clipping planes are equal ");
    OSAssertMessage_Line(2542, (l != r), "MTXLightFrustum():  'l' and 'r' clipping planes are equal ");
...
void C_MTXLightPerspective(Mtx m, f32 fovY, f32 aspect, f32 scaleS, f32 scaleT, f32 transS, f32 transT) {
    ...
    OSAssertMessage_Line(2604, m, "MTXLightPerspective():  NULL MtxPtr 'm' ");
    OSAssertMessage_Line(2605, (fovY > 0.0) && (fovY < 180.0), "MTXLightPerspective():  'fovY' out of range ");
    OSAssertMessage_Line(2606, 0 != aspect, "MTXLightPerspective():  'aspect' is 0 ");
...
void C_MTXLightOrtho(Mtx m, f32 t, f32 b, f32 l, f32 r, f32 scaleS, f32 scaleT, f32 transS, f32 transT) {
    ...
    OSAssertMessage_Line(2672, m, "MTXLightOrtho():  NULL MtxPtr 'm' ");
    OSAssertMessage_Line(2673, (t != b), "MTXLightOrtho():  't' and 'b' clipping planes are equal ");
    OSAssertMessage_Line(2674, (l != r), "MTXLightOrtho():  'l' and 'r' clipping planes are equal ");
    tmp = 1 / (r - l);
    m[0][0] = (2 * tmp * scaleS);
    m[0][1] = 0;
    m[0][2] = 0;

...
void C_QUATAdd(const Quaternion* p, const Quaternion* q, Quaternion* r) {
    ...
    OSAssertMessage_Line(84, r, "QUATAdd():  NULL QuaternionPtr 'r' ");
...
void C_QUATSubtract(const Quaternion* p, const Quaternion* q, Quaternion* r) {
    OSAssertMessage_Line(138, p, "QUATSubtract():  NULL QuaternionPtr 'p' ");
    OSAssertMessage_Line(139, q, "QUATSubtract():  NULL QuaternionPtr 'q' ");
    OSAssertMessage_Line(140, r, "QUATSubtract():  NULL QuaternionPtr 'r' ");
...
void C_QUATMultiply(const Quaternion* p, const Quaternion* q, Quaternion* pq) {
    ...
    OSAssertMessage_Line(198, p, "QUATMultiply():  NULL QuaternionPtr 'p' ");
    OSAssertMessage_Line(199, q, "QUATMultiply():  NULL QuaternionPtr 'q' ");
    OSAssertMessage_Line(200, pq, "QUATMultiply():  NULL QuaternionPtr 'pq' ");
...
void C_QUATScale(const Quaternion* q, Quaternion* r, f32 scale) {
    OSAssertMessage_Line(311, q, "QUATScale():  NULL QuaternionPtr 'q' ");
    OSAssertMessage_Line(312, r, "QUATScale():  NULL QuaternionPtr 'r' ");
...
f32 C_QUATDotProduct(const Quaternion* p, const Quaternion* q) {
    OSAssertMessage_Line(362, p, "QUATDotProduct():  NULL QuaternionPtr 'p' ");
    OSAssertMessage_Line(363, q, "QUATDotProduct():  NULL QuaternionPtr 'q' ");
...
void C_QUATNormalize(const Quaternion* src, Quaternion* unit) {
    f32 mag;
    OSAssertMessage_Line(412, src, "QUATNormalize():  NULL QuaternionPtr 'src' ");
    OSAssertMessage_Line(413, unit, "QUATNormalize():  NULL QuaternionPtr 'unit' ");
...
void C_QUATInverse(const Quaternion* src, Quaternion* inv) {
    f32 mag, norminv;
    OSAssertMessage_Line(503, src, "QUATInverse():  NULL QuaternionPtr 'src' ");
    OSAssertMessage_Line(504, inv, "QUATInverse():  NULL QuaternionPtr 'inv' ");
...
void C_QUATDivide(const Quaternion* p, const Quaternion* q, Quaternion* r) {
    Quaternion qtmp;
    OSAssertMessage_Line(611, p, "QUATDivide():  NULL QuaternionPtr 'p' ");
    OSAssertMessage_Line(612, q, "QUATDivide():  NULL QuaternionPtr 'q' ");
    OSAssertMessage_Line(613, r, "QUATDivide():  NULL QuaternionPtr 'r' ");
...
void C_QUATExp(const Quaternion* q, Quaternion* r)  {
    f32 theta, scale;
    OSAssertMessage_Line(648, q, "QUATExp():  NULL QuaternionPtr 'q' ");
    OSAssertMessage_Line(649, r, "QUATExp():  NULL QuaternionPtr 'r' ");
    OSAssertMessage_Line(652, q->w == 0.0f, "QUATExp():  'q' is not a pure quaternion. ");
...
void C_QUATMakeClosest(const Quaternion* q, const Quaternion* qto, Quaternion* r) {
    f32 dot;
    OSAssertMessage_Line(727, q, "QUATMakeClosest():  NULL QuaternionPtr 'q' ");
    OSAssertMessage_Line(728, qto, "QUATMakeClosest():  NULL QuaternionPtr 'qto' ");
    OSAssertMessage_Line(729, r, "QUATMakeClosest():  NULL QuaternionPtr 'r' ");
...
void C_QUATRotAxisRad(Quaternion* r, const Vec* axis, f32 rad) {
    ...
    OSAssertMessage_Line(763, r, "QUATRotAxisRad():  NULL QuaternionPtr 'r' ");
    OSAssertMessage_Line(764, axis, "QUATRotAxisRad():  NULL VecPtr 'axis' ");
...
void C_QUATMtx(Quaternion* r, const Mtx m) {
    ...
    OSAssertMessage_Line(796, r, "QUATMtx():  NULL QuaternionPtr 'r' ");
    OSAssertMessage_Line(797, m, "QUATMtx():  NULL MtxPtr 'm' ");
...
void C_QUATLerp(const Quaternion* p, const Quaternion* q, Quaternion* r, f32 t) {
    OSAssertMessage_Line(847, p, "QUATLerp():  NULL QuaternionPtr 'p' ");
    OSAssertMessage_Line(848, q, "QUATLerp():  NULL QuaternionPtr 'q' ");
    OSAssertMessage_Line(849, r, "QUATLerp():  NULL QuaternionPtr 'r' ");
...
void C_QUATSlerp(const Quaternion* p, const Quaternion* q, Quaternion* r, f32 t) {
    ...
    OSAssertMessage_Line(874, p, "QUATSlerp():  NULL QuaternionPtr 'p' ");
    OSAssertMessage_Line(875, q, "QUATSlerp():  NULL QuaternionPtr 'q' ");
    OSAssertMessage_Line(876, r, "QUATSlerp():  NULL QuaternionPtr 'r' ");
...
void C_QUATSquad(const Quaternion* p, const Quaternion* a, const Quaternion* b, const Quaternion* q, Quaternion* r, f32 t) {
    ...
    OSAssertMessage_Line(932, p, "QUATSquad():  NULL QuaternionPtr 'p' ");
    OSAssertMessage_Line(933, a, "QUATSquad():  NULL QuaternionPtr 'a' ");
    OSAssertMessage_Line(934, b, "QUATSquad():  NULL QuaternionPtr 'b' ");
    OSAssertMessage_Line(935, q, "QUATSquad():  NULL QuaternionPtr 'q' ");
    OSAssertMessage_Line(936, r, "QUATSquad():  NULL QuaternionPtr 'r' ");
...
void C_QUATCompA(const Quaternion* qprev, const Quaternion* q, const Quaternion* qnext, Quaternion* a) {
    ...
    OSAssertMessage_Line(963, qprev, "QUATCompA():  NULL QuaternionPtr 'qprev' ");
    OSAssertMessage_Line(964, q, "QUATCompA():  NULL QuaternionPtr 'q' ");
    OSAssertMessage_Line(965, qnext, "QUATCompA():  NULL QuaternionPtr 'qnext' ");
    OSAssertMessage_Line(966, a, "QUATCompA():  NULL QuaternionPtr 'a' ");

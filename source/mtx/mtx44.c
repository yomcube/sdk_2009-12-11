...
void C_MTXFrustum(Mtx44 m, f32 t, f32 b, f32 l, f32 r, f32 n, f32 f) {
    ...
    OSAssertMessage_Line(115, m, "MTXFrustum():  NULL Mtx44Ptr 'm' ");
    OSAssertMessage_Line(116, t != b, "MTXFrustum():  't' and 'b' clipping planes are equal ");
    OSAssertMessage_Line(117, l != r, "MTXFrustum():  'l' and 'r' clipping planes are equal ");
    OSAssertMessage_Line(118, n != f, "MTXFrustum():  'n' and 'f' clipping planes are equal ");
    tmp = 1 / (r - l);
    m[0][0] = (2 * n * tmp);
    m[0][1] = 0;
    m[0][2] = (tmp * (r + l));
...
void C_MTXPerspective(Mtx44 m, f32 fovY, f32 aspect, f32 n, f32 f) {
    ...
    OSAssertMessage_Line(184, m, "MTXPerspective():  NULL Mtx44Ptr 'm' ");
...
void C_MTXOrtho(Mtx44 m, f32 t, f32 b, f32 l, f32 r, f32 n, f32 f) {
    ...
    OSAssertMessage_Line(254, m, "MTXOrtho():  NULL Mtx44Ptr 'm' ");
    OSAssertMessage_Line(255, t != b, "MTXOrtho():  't' and 'b' clipping planes are equal ");
    OSAssertMessage_Line(256, l != r, "MTXOrtho():  'l' and 'r' clipping planes are equal ");
    OSAssertMessage_Line(257, n != f, "MTXOrtho():  'n' and 'f' clipping planes are equal ");
    tmp = 1 / (r - l);
    m[0][0] = 2 * tmp;
    m[0][1] = 0;
    m[0][2] = 0;
...
void C_MTX44Identity(Mtx44 m) {
    OSAssertMessage_Line(320, m != 0, "MTX44Identity():  NULL Mtx44 'm' ");
...
void C_MTX44Copy(const Mtx44 src, Mtx44 dst) {
    OSAssertMessage_Line(378, src != 0, "MTX44Copy():  NULL Mtx44Ptr 'src' ");
    OSAssertMessage_Line(379, dst != 0, "MTX44Copy():  NULL Mtx44Ptr 'dst' ");
...
void C_MTX44Concat(const Mtx44 a, const Mtx44 b, Mtx44 ab) {
    ...
    OSAssertMessage_Line(450, a, "MTX44Concat():  NULL Mtx44Ptr 'a'  ");
    OSAssertMessage_Line(451, b, "MTX44Concat():  NULL Mtx44Ptr 'b'  ");
    OSAssertMessage_Line(452, ab, "MTX44Concat():  NULL Mtx44Ptr 'ab' ");
...
void C_MTX44Transpose(const Mtx44 src, Mtx44 xPose) {
    ...
    OSAssertMessage_Line(633, src, "MTX44Transpose():  NULL Mtx44Ptr 'src' ");
    OSAssertMessage_Line(634, xPose, "MTX44Transpose():  NULL Mtx44Ptr 'xPose' ");
...
u32 C_MTX44Inverse(const Mtx44 src, Mtx44 inv) {
    ...
    OSAssertMessage_Line(730, src, "MTX44Inverse():  NULL Mtx44Ptr 'src' ");
    OSAssertMessage_Line(731, inv, "MTX44Inverse():  NULL Mtx44Ptr 'inv' ");
...
void C_MTX44Trans(Mtx44 m, f32 xT, f32 yT, f32 zT) {
    OSAssertMessage_Line(831, m, "MTX44Trans():  NULL Mtx44Ptr 'm' ");
...
void C_MTX44TransApply(const Mtx44 src, Mtx44 dst, f32 xT, f32 yT, f32 zT) {
    OSAssertMessage_Line(895, src, "MTX44TransApply(): NULL Mtx44Ptr 'src' ");
    OSAssertMessage_Line(896, dst, "MTX44TransApply(): NULL Mtx44Ptr 'src' "); //! wrong assert string
...
void C_MTX44Scale(Mtx44 m, f32 xS, f32 yS, f32 zS) {
    OSAssertMessage_Line(972, m, "MTX44Scale():  NULL Mtx44Ptr 'm' ");
    m[0][0] = xS;
    m[0][1] = 0.0f;
    m[0][2] = 0.0f;
    m[0][3] = 0.0f;
...
void C_MTX44ScaleApply(const Mtx44 src, Mtx44 dst, f32 xS, f32 yS, f32 zS) {
    OSAssertMessage_Line(1032, src, "MTX44ScaleApply(): NULL Mtx44Ptr 'src' ");
    OSAssertMessage_Line(1033, dst, "MTX44ScaleApply(): NULL Mtx44Ptr 'dst' ");
...
void C_MTX44RotRad(Mtx44 m, char axis, f32 rad) {
    ...
    OSAssertMessage_Line(1114, m, "MTX44RotRad():  NULL Mtx44Ptr 'm' ");
    sinA = sinf(rad);
    cosA = cosf(rad);
...
void C_MTX44RotTrig(Mtx44 m, char axis, f32 sinA, f32 cosA) {
    OSAssertMessage_Line(1159, m, "MTX44RotTrig():  NULL Mtx44Ptr 'm' ");
    ...
    case 'z':
        ...
        break;
    default:
        OSAssertMessage_Line(1187, FALSE, "MTX44RotTrig():  invalid 'axis' value ");
        break;
    }
}
...
void C_MTX44RotAxisRad(Mtx44 m, const Vec* axis, f32 rad) {
    ...
    OSAssertMessage_Line(1296, m, "MTX44RotAxisRad():  NULL Mtx44Ptr 'm' ");
    OSAssertMessage_Line(1297, axis, "MTX44RotAxisRad():  NULL VecPtr 'axis' ");

...
void C_MTXMultVec(const Mtx m, const Vec* src, Vec* dst) {
    ...
    OSAssertMessage_Line(72, m, "MTXMultVec():  NULL MtxPtr 'm' ");
    OSAssertMessage_Line(73, src, "MTXMultVec():  NULL VecPtr 'src' ");
    OSAssertMessage_Line(74, dst, "MTXMultVec():  NULL VecPtr 'dst' ");
...
void C_MTXMultVecArray(const Mtx m, const Vec* srcBase, Vec* dstBase, u32 count) {
    ...
    OSAssertMessage_Line(174, m, "MTXMultVecArray():  NULL MtxPtr 'm' ");
    OSAssertMessage_Line(175, srcBase, "MTXMultVecArray():  NULL VecPtr 'srcBase' ");
    OSAssertMessage_Line(176, dstBase, "MTXMultVecArray():  NULL VecPtr 'dstBase' ");
    OSAssertMessage_Line(177, count > 1, "MTXMultVecArray():  count must be greater than 1.");
...
void C_MTXMultVecSR(const Mtx m, const Vec* src, Vec* dst) {
    ...
    OSAssertMessage_Line(319, m, "MTXMultVecSR():  NULL MtxPtr 'm' ");
    OSAssertMessage_Line(320, src, "MTXMultVecSR():  NULL VecPtr 'src' ");
    OSAssertMessage_Line(321, dst, "MTXMultVecSR():  NULL VecPtr 'dst' ");
...
void C_MTXMultVecArraySR(const Mtx m, const Vec* srcBase, Vec* dstBase, u32 count) {
    ...
    OSAssertMessage_Line(416, m, "MTXMultVecArraySR():  NULL MtxPtr 'm' ");
    OSAssertMessage_Line(417, srcBase, "MTXMultVecArraySR():  NULL VecPtr 'srcBase' ");
    OSAssertMessage_Line(418, dstBase, "MTXMultVecArraySR():  NULL VecPtr 'dstBase' ");
    OSAssertMessage_Line(419, count > 1, "MTXMultVecArraySR():  count must be greater than 1.");

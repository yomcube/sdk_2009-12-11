...
{
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0xcf [original object]
	struct _VEC2
	{
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0x15b [original object]
	struct _VEC3
	{
		f32	x;	// size 0x04, offset 0x00
		f32	y;	// size 0x04, offset 0x04
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0x1d4 [original object]
	struct _VEC4
	{
		f32	x;	// size 0x04, offset 0x00
		f32	y;	// size 0x04, offset 0x04
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0xee1 [original object]
	struct _QUAT
	{
		f32	x;	// size 0x04, offset 0x00
		f32	y;	// size 0x04, offset 0x04
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0x2ea [original object]
	struct _MTX33
	{
		// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0x3b0 [original object]
		union
		{
			// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0x465 [original object]
			struct
			{
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0x56d [original object]
	struct _MTX34
	{
		// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0x66b [original object]
		union
		{
			// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0x758 [original object]
			struct
			{
				f32	_00;	// size 0x04, offset 0x00
				f32	_01;	// size 0x04, offset 0x04
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0xa2d [original object]
	struct _MTX44
	{
		// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0xb63 [original object]
		union
		{
			// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0xc88 [original object]
			struct
			{
				f32	_00;	// size 0x04, offset 0x00
				f32	_01;	// size 0x04, offset 0x04
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0xb7 [original object]
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0x143 [original object]
	...
	public:
		...
		operator CVecPtr() const { return reinterpret_cast<CVecPtr>(this); }
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0x1bc [original object]
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0xec9 [original object]
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0x2d1 [original object]
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0x554 [original object]
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_types.o(1)::.debug_info::0xa14 [original object]
...
# pragma unused(p1, p2, a, b, c)
	...
	inline VEC3 *VEC3Scale(register VEC3 *pOut, register VEC3 const *p,
	                       register f32 scale)
	{
		register f32 a, b;
...
# pragma unused(p, scale, a, b)
	...
	inline VEC3 *VEC3Lerp(register VEC3 *pOut, register VEC3 const *p1,
	                      register VEC3 const *p2, register f32 t)
	{
		register f32 a, b, c;
...
# pragma unused(p, vxy, vzz)
	...
	VEC4 *VEC3TransformArray(VEC4 *pOut, MTX44 const *pM, VEC3 const *pV,
	                         u32 count);
	...
	VEC4 *VEC4TransformArray(VEC4 *pOut, MTX44 const *pM, VEC4 const *pV,
	                         u32 count);
